...
`}
  ...
  <div className="relative">
    <img className="w-16 h-16 rounded-full" src="https://huggingface.co/Jersonm89/Avatar/resolve/main/jonny_2.png" alt />
    <span className="top-0 left-7 absolute  w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full" />
  </div>
  <div className="relative">
    <img className="w-16 h-16 rounded" src="https://huggingface.co/Jersonm89/Avatar/resolve/main/jonny_2.png" alt />
    <span className="absolute top-0 left-8 transform -translate-y-1/2 w-3.5 h-3.5 bg-red-400 border-2 border-white dark:border-gray-800 rounded-full" />
  </div>
  <div className="relative">
    <img className="w-16 h-16 rounded-full" src="https://huggingface.co/Jersonm89/Avatar/resolve/main/jonny_2.png" alt />
  ...
  <div className="relative">
    ...
    <span className="absolute bottom-0 left-8 transform translate-y-1/4 w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full" />
      ...
      <CodeBox text={'Sizes Avatar'} stringCode={`
  ...
  <img className="w-6 h-6 rounded" src="https://cdn.openart.ai/stable_diffusion/853e3cb67e034e85f9747651667bd1a901ca4863_2000x2000.webp" alt="Extra small avatar" />
  <img className="w-8 h-8 rounded" src="https://cdn.openart.ai/stable_diffusion/853e3cb67e034e85f9747651667bd1a901ca4863_2000x2000.webp" alt="Small avatar" />
  <img className="w-10 h-10 rounded" src="https://cdn.openart.ai/stable_diffusion/853e3cb67e034e85f9747651667bd1a901ca4863_2000x2000.webp" alt="Medium avatar" />
  <img className="w-20 h-20 rounded" src="https://cdn.openart.ai/stable_diffusion/853e3cb67e034e85f9747651667bd1a901ca4863_2000x2000.webp" alt="Large avatar" />
  <img className="rounded w-36 h-36" src="https://cdn.openart.ai/stable_diffusion/853e3cb67e034e85f9747651667bd1a901ca4863_2000x2000.webp" alt="Extra large avatar" />
