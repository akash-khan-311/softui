...
`}
      >
        <div className="max-w-[400px] bg-gradient-to-tr from-[#07102d] to-[#3a3c54] border border-[#545a6a] rounded-[20px] p-6">
          <span className="font-semibold text-[14px] text-blue-500 mb-2">
            Download Now!
          </span>
          <h2 className="font-semibold text-white text-2xl mb-4">
            Download our mobile application.
          </h2>
          <p className="text-[#9799a7] text-[13px]">
            Download Lorem mobile banking app for IOS & Android to manage your
            online money.
          </p>
          <div className="flex justify-center mt-4 space-x-4">
            <button className="flex items-center justify-between rounded-[10px] py-2 px-4 bg-blue-500 hover:shadow-md focus:outline-none focus:ring focus:ring-blue-300">
              <span className="h-[25px] w-[25px]">
                ...
                >
                  <path
                    d="M4 28.9958V4.9125C4 4.07667 4.48167 3.34 5.19 3l14.9542 13.9542L5.19 30.9083C4.48167 30.5542 4 29.8317 4 28.9958ZM23.5642 21.3742L8.32083 30.1858L20.3483 18.1583L23.5642 21.3742ZM28.31 15.2683C28.7917 15.6508 29.1458 16.2458 29.1458 16.9542C29.1458 17.6625 28.8342 18.2292 28.3383 18.6258L25.0942 20.4958L21.5525 16.9542L25.0942 13.4125L28.31 15.2683ZM8.32083 3.7225L23.5642 12.5342L20.3483 15.75L8.32083 3.7225Z"
                    fill="white"
                  ></path>
                </svg>
              </span>
            ...
            <button className="flex items-center justify-between rounded-[10px] py-2 px-4 bg-white hover:shadow-md focus:outline-none focus:ring focus:ring-blue-300">
              <span className="h-[25px] w-[25px]">
                <svg
                  fill="#000000"
                  width="34"
                  height="34"
                  viewBox="-52.01 30 860.035 660.035"
                  xmlns="http://www.w3.org/2000/svg"
                >
