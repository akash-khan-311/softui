...
export default function CTA2() {
  return (
    <>
      <CodeBox
        stringCode={`<div className="relative z-10 overflow-hidden bg-indigo-600 py-16 px-8">
    <div className="container">
      <div className="-mx-4 flex flex-wrap items-center">
        <div className="w-full px-4 lg:w-1/2">
          <div className="text-center lg:text-left ">
            <div className="mb-10 lg:mb-0 ">
              <h1 className="mt-0 mb-3 text-3xl font-bold leading-tight sm:text-4xl sm:leading-tight md:text-[40px] md:leading-tight text-white ">Start building automated serverless forms</h1>
    ...
    <span className="absolute top-4 left-4 -z-10">
      ...
      >
        <div className="relative z-10 overflow-hidden bg-indigo-600 py-16 px-8">
          <div className="container">
            <div className="-mx-4 flex flex-wrap items-center">
              <div className="w-full px-4 lg:w-1/2">
                <div className="text-center lg:text-left ">
