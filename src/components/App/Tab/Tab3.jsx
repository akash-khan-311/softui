            ...
            {TabData.map((item, index) => (
              <li key={index} className="mr-2">
                <a
                  ...
                  href="#!"
                  className={`inline-block py-2 px-4 text-xl border-b-2 border-transparent rounded-t-lg hover:text-pink-600 ${active === index ? "text-pink-600 border-pink-600" : "text-black border-transparent"} `}
                >
                  {item}
                </a>
              </li>
