  ...
  const toggleDrawer = () => {
    ...
    return (
        ...
        <div className="relative">
          {/* Drawer */}
          <div className={\`fixed  top-0 left-0 bottom-0 z-50 bg-blue-900 text-white p-6 w-64 transition-transform transform duration-500 \${isOpen ? 'translate-x-0' : '-translate-x-full'}\`}>
...
`}
      >
        ...
        <div className="flex justify-center">
          <button
            ...
            className="text-white font-medium text-base inline-block outline-none  cursor-pointer  transition-shadow bg-gradient-to-br from-blue-300 to-blue-700 hover:from-blue-400 hover:to-blue-800 hover:shadow-md active:shadow-inner active:translate-y-0.1 transform-gpu border-none rounded-md px-8 py-3"
          >
            Left Side
          </button>
        </div>
      ...
      <div className="relative">
        {/* Drawer */}
        <div
          className={`fixed  top-0 left-0 bottom-0 z-50 bg-blue-900 text-white p-6 w-64 transition-transform transform duration-500 ${
