      ...
      <CodeBox text={"Default Modal"} stringCode={modalcode}>
        <div>
          <button
            ...
            className="bg-gradient-to-tr from-blue-900 to-blue-500 rounded-md py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
          >
            Open Dialog
          </button>
          <div
          ...
          >
            <div
              ...
              className={`absolute m-4 w-2/5 min-w-[40%] max-w-[40%] rounded-lg bg-white font-sans text-base font-lightd text-blue-gray-500 ${
                modalOpen
            ...
            >
              ...
              <div className="relative p-4 font-sans text-base antialiased font-light leading-relaxed border-t border-b border-t-blue-gray-100 border-b-blue-gray-100 text-blue-gray-500">
                ...
                Repellat eveniet aperiam veritatis voluptate architecto vitae,
