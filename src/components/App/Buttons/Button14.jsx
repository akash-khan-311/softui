    ...
    <nav className="border-b">
      <div className="container relative max-w-screen-lg mx-auto flex justify-between h-14">
        ...
        <a href="#" className="flex items-center cursor-pointer hover:bg-purple-50 px-2 ml-3">
          {/* Logo */}
          <div className="rounded bg-purple-400 text-white font-bold w-10 h-10 flex justify-center text-3xl pt-0.5">A</div>
          <div className="text-gray-700 font-semibold ml-2">Alphabet Tech</div>
        </a>
        {/* Navbar Toggle Button */}
        <button onClick={() => setShowMenu(!showMenu)} className="block md:hidden text-gray-700 p-2 rounded hover:border focus:border focus:bg-gray-100 my-2 mr-5" type="button" aria-controls="navbar-main" aria-expanded={showMenu} aria-label="Toggle navigation">
