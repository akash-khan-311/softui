...
const Form2 = () => {
  return (
    <>
      <CodeBox
        text={"Login Form With Social Button"}
        stringCode={`import React from 'react';

const LoginForm = () => {
  return (
    <div className="relative py-3 sm:max-w-xl sm:mx-auto">
    <div className="relative px-4 py-10 bg-gray-300 mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
      <div className="max-w-md mx-auto">
        <div className="flex items-center space-x-5 justify-center">
          <h2 className="text-5xl font-semibold">
            Aero <span className="text-yellow-900">UI</span>
          </h2>
        </div>
        <div className="mt-5">
          <label
