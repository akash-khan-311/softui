...
const Footer2 = () => {
  return (
    <>
      <CodeBox
        text={"Footer With Links"}
        stringCode={`<footer className="flex flex-col items-center bg-gray-100 text-center lg:text-left">
...
`}
      >
        <footer className="flex flex-col items-center bg-gray-100 text-center  lg:text-left">
          <div className="container p-6 border-b border-gray-300">
            <div className="grid place-items-center md:grid-cols-2 lg:grid-cols-4 ">
              {/*First links section*/}
              <div className="mb-6">
