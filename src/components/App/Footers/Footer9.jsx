...
const Footer9 = () => {
  return (
    <CodeBox stringCode={`<footer className="flex flex-col justify-around gap-5 text-white  py-8">
    ...
    <aside className="text-center text-sm">
      <p>&copy; 2024 SOFT UI. All Rights Reserved.</p>
    </aside>
  </footer>`}>
      <footer className="flex flex-col justify-around gap-5 text-white  py-8">
        <nav className="text-lg">
          <ul className="flex h-full flex-wrap items-center justify-center gap-3">
            <li>
              <a className="cursor-pointer hover:underline">Home</a>
