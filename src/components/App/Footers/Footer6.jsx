...
const Footer6 = () => {
  return (
    <>
      <CodeBox
        stringCode={`<footer className="relative bg-gray-300 pt-8 pb-6 font-sans">
    ...
    <div className="flex flex-wrap items-center md:justify-between justify-center">
      <div className="w-full md:w-4/12 px-4 mx-auto text-center">
        <div className="text-sm text-blueGray-500 font-semibold py-1">
          Copyright © <span id="get-current-year">2024</span><a href="#!" className=" hover:text-orange-600" > Soft UI
          </a>
        </div>
      </div>
    </div>
      ...
      >
        <footer className="relative bg-gray-300 pt-8 pb-6 font-sans">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap text-left lg:text-left">
              <div className="w-full lg:w-6/12 px-4">
