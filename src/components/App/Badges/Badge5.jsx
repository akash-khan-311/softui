...
const Badge5 = () => {
  return (
    <CodeBox text="Rounded Badges" stringCode="">
      <div className="flex justify-center gap-5 flex-wrap items-center space-x-3">
        <span className="bg-gray-400 text-gray-400 px-2  py-.5 rounded-full bg-opacity-20 border-gray-400 border-.5 text-sm">Disabled</span>
