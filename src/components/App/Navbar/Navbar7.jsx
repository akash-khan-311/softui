...
const Navbar7 = () => {
  return (
    <>
      <CodeBox
        text={""}
        stringCode={`<nav className=" inset-x-0 top-0 z-30 mx-auto w-full max-w-screen-md border border-gray-100 bg-white/80 py-3 shadow backdrop-blur-lg md:top-6 md:rounded-3xl lg:max-w-screen-lg">
  <div className="px-4">
      ...
      <div className="flex shrink-0">
        <a aria-current="page" className="flex items-center" href="#!">
          <img
            ...
            alt
          />
          <span className="text-lg font-semibold ml-3">Soft UI</span>
        </a>
      </div>
