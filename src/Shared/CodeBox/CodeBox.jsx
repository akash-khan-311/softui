    ...
    <>
      <div className={`w-full rounded-md h-fit  px-4 py-2`}>
        <div className={`w-full rounded-md h-fit  px-4 py-1 my-10 `}>
          ...
          <div className="flex gap-2 items-center justify-end rounded-t-lg border border-gray-50 shadow-lg bg-gradient-to-br from-cyan-900 to-purple-900 py-5">
            <div className="flex ">
              {isCodeBoxOpen ? (
                <div className="">
                  <button
                  ...
                  >
                    <IoMdEye
                      ...
                      onClick={() => setIsCodeBoxOpen(!isCodeBoxOpen)}
                    />
                    <span className="text-lg text-white ml-2">Hidden Code</span>
                  </button>
                </div>
              ) : (
                <div>
